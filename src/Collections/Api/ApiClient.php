...
namespace MrBeaver\Selectel\CloudStorage\Api;
...
use MrBeaver\Selectel\CloudStorage\Exceptions\AuthenticationFailedException;

class ApiClient implements ApiClientContract
{
    const AUTH_URL = 'https://api.selcdn.ru/auth/v1.0';
     ...
     *
     * @throws \MrBeaver\Selectel\CloudStorage\Exceptions\AuthenticationFailedException
